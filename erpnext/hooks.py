...
default_mail_footer = """
	<span>
		Sent via
		<a class="text-muted" href="https://erp.co.zm?source=via_email_footer" target="_blank">
			Pro Enterprise Retail
		</a>
	</span>
"""
...
regional_overrides = {
	...
	'Zambia': {
		'erpnext.tests.test_regional.test_method': 'erpnext.regional.india.utils.test_method',
		'erpnext.controllers.taxes_and_totals.get_itemised_tax_breakup_header': 'erpnext.regional.india.utils.get_itemised_tax_breakup_header',
		'erpnext.controllers.taxes_and_totals.update_itemised_tax_data': 'erpnext.regional.india.utils.get_itemised_tax_breakup_data'
	}
}
